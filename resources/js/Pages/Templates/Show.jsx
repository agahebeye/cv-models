        ...
        >
            ...
            <div className="pb-6 page">
                ...
                <div className="max-w-xs mx-auto mt-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
                    ...
                    <Link className="block px-4 py-2 mx-6 mb-6 text-xs font-semibold tracking-widest text-center text-white uppercase transition duration-150 ease-in-out bg-gray-900 border border-transparent rounded-md active:bg-gray-900">
                        open in editor
                    </Link>
