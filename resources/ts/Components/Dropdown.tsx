...
interface IDropdownContenChildren extends IDropdownChildren {
    align: string;
    width: string;
    contentClasses: string;
}

interface IDropdownLinkChildren extends IDropdownChildren {
    href: string;
    method?: string;
    as?: string;
}
...
const DropDownContext = React.createContext<IDropdownContext>(defaultState);
...
const Trigger = ({ children }: IDropdownChildren) => {
...
const Content = ({
    ...
    children,
}: Partial<IDropdownContenChildren>) => {
...
const DropdownLink = ({ href, method, as, children }: IDropdownLinkChildren) => {
    return (
        <Link
            href={href}
            method={method}
